...
const Achievements = ({ achievementsRef, setActiveNavMenu }) => {
    ...
    useEffect(() => {
        if (inView) {
            setActiveNavMenu("achievements");
        }
    }, [inView])

    return (
        <>
            <div ref={achievementsRef} className="w-full flex justify-center items-center gap-3">
